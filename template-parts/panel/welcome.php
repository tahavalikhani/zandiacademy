...
<section class="p-welcome" aria-labelledby="panel-title">
	<p class="c-eyebrow"><?php echo esc_html( $zandi_copy['eyebrow'] ); ?></p>

	<h1 class="p-welcome__title" id="panel-title">
		<?php
		echo $zandi_name
	...
	<p class="p-welcome__lead"><?php echo esc_html( $zandi_copy['intro'] ); ?></p>

	<nav class="p-tabs" aria-label="<?php echo esc_attr( $zandi_copy['eyebrow'] ); ?>">
