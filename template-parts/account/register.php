...
<section class="p-auth" aria-labelledby="auth-title">
	<div class="p-auth__card">
		...
		<?php if ( ! $zandi_open ) : ?>
			 ...
			 */
			?>
			<p class="p-auth__closed"><?php echo esc_html( $zandi_copy['closed'] ); ?></p>

			<a class="c-btn c-btn--primary c-btn--block" href="<?php echo esc_url( $zandi_contact['telegram'] ); ?>" rel="noopener">
				باز کردن تلگرام
			</a>
		...
		<?php else : ?>
			<form class="p-form" method="post" action="<?php echo esc_url( zandi_register_url() ); ?>" novalidate>
