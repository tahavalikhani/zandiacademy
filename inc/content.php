...
ZANDI_REVIEW_3,
			...
			array(
				'name'    => 'ملیکا قزاقی',
				'courses' => array( 'a1', 'a2' ),
				'quote'   => <<<'ZANDI_REVIEW_4'
من تقریبا دو سه بار قبل از دوره های افلاین شیما جون زبان فرانسه رو شروع کردم ولی خب زیاد برام کارساز نبود.
این‌ دوره های افلاین چندتا مزیت برای من داشت که دوست دارم همه بدونن .
اول اینکه شیما جون به عنوان مدرس زبان بسیار بسیار روون تدریس میکنن
دوم اینکه پشتیبانی تیم همیشه در دسترس هستن و اینکه شیما جون بعد از هر دوره جلسه آنلاین میذارن و اشکالاتت رو میگیرن باعث میشه که تو نه فشاری باشه روت برای اینکه سریع یاد بگیری و جواب پس بدی و هم اینکه باعث میشه با زمان بندی خودت بری جلو و حس کنی داری جدا حمایت میشی از طرف استادت
نزدیک دو ساله که من شیما جون رو میشناسم و واقعا میتونم بگم یکی از دلسوز ترین و بهترین استاد هایی هستن که میشناسم
مخصوصا اگه مثل من بچه ها مهاجر باشن خیلی خیلی کمک میشه این دوره ها براشون چون بین کار کردن و درس خوندن آدم باید وقتشو تنظیم کنه برای یادگیری زبان
ZANDI_REVIEW_4,
			),
			array(
				'name'    => 'شادان حیدرپور',
				'courses' => array( 'a1', 'a2' ),
				'quote'   => <<<'ZANDI_REVIEW_5'
سلام خدمت شما
من دوره ای افلاین شیما جان رو برداشتم پایه ی A1و تموم شد
میتونستم کلی متن بنویسم و جمله سازی کنم
بعد گفتم پس خودم میخونم
والان به این نتیجه رسیدم که خودم نمیتونم ادامه بدم و باید امتحان بدم و به صورت آکادمیک برم جلو
دوباره دوره ی A2رو هم برداشتم و بسیار راضیم
بالاخره بعد مدت ها خوشحالم مثلا مورد Imparfait رو فرقش با passée composé فهمیدم
و خوشحالم که دوباره دارم باهاتون ادامه میدم ✅
واقعا کامنت دلی بود که باید میزاشتم ❤️
ZANDI_REVIEW_5,
			),
			/*
			 * Third on purpose. She bought two courses so she sorts into the
			 * leading group, but the owner asked on 15 September 2026 that she
			 * not be the first card — position here is what delivers that,
			 * because zandi_sort_testimonials() keeps the given order inside
			 * each group. Moving her above ملیکا or شادان undoes it.
			 */
			array(
				'name'    => 'مهدیه ولیزاده',
				'courses' => array( 'a2', 'b1' ),
				'quote'   => <<<'ZANDI_REVIEW_7'
سلام وقتتون بخیر
من از خانوم زندی پکیج A2 وB1 تهیه کردم
چون آفلاین بود و من چندبار میتونستم ویدیو هارو ببینم خیلی کمکم میکرد این موضوع
مکالمه محور بود و نیاز نبود مثل کتاب همه چیز رو حفظ کنم
باخودشون میتونستم جلسه داشته باشم و اشکالاتمو برطرف کنم
پشتیبانی عالی بود و به موقع پاسخگو بودن
ZANDI_REVIEW_7,
			),
			array(
				'name'    => 'سوگل دمرلی',
				'courses' => array( 'a1', 'a2', 'b1' ),
				'quote'   => <<<'ZANDI_REVIEW_9'
سلام وقت بخیر
من خواستم تشکر کنم ازتون بابت کلاس های آنلاین و آفلاین بی نظیرتون
من کاملا سطحم صفر بود ، که خب کلاس های آفلاین سطح A1 و به ترتیب A2 و b1 رو تهیه کردم .
خیلی راضی بودم و شیما جون که ازم تعیین سطح گرفت ، الان سطحم B1 هست . خیلی ممنونم از شیما جون و تیم زندی آکادمی 🩷 انقدر با حوصله وقت میذارن برای پاسخ دادن به سوالات ما🥰
ZANDI_REVIEW_9,
			),
			array(
				'name'    => 'صالحه شریفی',
				'courses' => array( 'a2' ),
				'quote'   => <<<'ZANDI_REVIEW_6'
واقعا دروه عالی و بی نقص  اگرچه خیلی آهسته دارم میرم جلو ولی پیشتبانی دایم همیشه پاسخگو بودید و خود دوره که واقعا کامل و قابل فهم است تا این جای که خوندم واقعا قشنگ همه چیو فهمیدم و حال می‌کنم 🫶🏻
هرچی زودتر میام برا A2🫶🏻
ZANDI_REVIEW_6,
			),
			array(
				'name'    => 'نگین بیگی',
				'courses' => array( 'a2' ),
				'quote'   => <<<'ZANDI_REVIEW_8'
من‌ با شیما جون هم کلاس آنلاین و هم آفلاین داشتم، خیلی راحت‌تر و دوست داشتنی‌تر فرانسوی رو با متد و تدریس شیما جون یادگرفتم. 😍🤩
ZANDI_REVIEW_8,
			),
			array(
				'name'    => 'پریسا رفیع‌زاده',
				'courses' => array( 'a1' ),
				'quote'   => <<<'ZANDI_REVIEW_10'
من به شخصه خودم خیلییی زیاد زبان فرانسه رو دوست دارم ، و اون جایی که وقت کلاس رو نداشتم برام بهترین گزینه بود چون میتونستم توی هر تایمی که میخواستم ببینم🫠
خود کلاس و روند آموزش واقعاا قشنگه، اصلاااا خسته کننده نیست و بعد از تموم شدن هر قسمت آدم دلش میخواد سریع بره قسمت بعدی😅😍
به نظرم باید به پروسه اعتماد کرد، بعضی از لغات واقعا سختن ولی اینکه میشنویم و گوشمون آشنا میشه خیلی کمک کنندس،و بعد از یه مدت به نظرم خیلییی بیشتر از اون سطحی که هستیم میفهمیم
من تا A1.2 رو خوندم و همینجوری رفتم موسسه تعیین سطح کردم و باورم نمیشد گفتن ترم ۴ رو میتونی بیای😅😅
خلاصه که من خیلیییی زیاد این دوره رو دوست دارم به خصوص اون نوری که از بیرون میاد و حال و هوای کلاس و صدای قهوه ساز😭😭😍
ZANDI_REVIEW_10,
			),
		)
	);
...
function zandi_testimonials_copy() {
	return apply_filters(
		...
		array(
			...
			'more'         => 'ادامه مطلب',
			'less'         => 'بستن',
			// %s is the student's name. Read only by screen readers, so that
			// six «ادامه مطلب» buttons are not six identical controls.
			'more_sr'      => 'نظر %s',
